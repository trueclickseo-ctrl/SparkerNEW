(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,22527,e=>{"use strict";var t=e.i(43476),a=e.i(71645),r=e.i(22016),o=e.i(49621),i=e.i(70065),s=e.i(94179),n=e.i(67881);let l=[{slug:"10-tips-for-unforgettable-date-night",title:"10 Expert Tips for an Unforgettable Date Night at Home",excerpt:"Transform an ordinary evening into a romantic connection ritual with card decks and conversation starters.",content:`Date nights do not always require expensive restaurant reservations or traveling out of town. With thoughtful planning and structured conversation prompts, your living room can become the ultimate sanctuary for romance.
...
Draw prompts from the 89 Intimacy Deck to spark deep reflections, revisit cherished memories, and explore shared dreams.`,category:"Couples Advice",author:{name:"Dr. Sarah Jenkins",role:"Relationship Counselor",avatar:"/authors/sarah.jpg"},publishedAt:"2026-07-20",readTime:"5 min read",tags:["Couples","Date Night","Romance"]},{slug:"how-to-host-the-ultimate-party-game-night",title:"How to Host the Ultimate Party Game Night (Zero Awkward Silences)",excerpt:"Step-by-step host guide for organizing icebreakers, team games, and party snacks for maximum group energy.",content:`Hosting a memorable game night requires balancing energy, choosing the right game deck, and keeping everyone involved.
...
Keep group dynamics fresh by shuffling seating arrangements between game rounds so everyone interacts with new guests.`,category:"Party Tips",author:{name:"Marcus Vance",role:"Event & Party Host Specialist",avatar:"/authors/marcus.jpg"},publishedAt:"2026-07-18",readTime:"6 min read",tags:["Party","Hosting","Icebreakers"]},{slug:"mastering-mafia-and-werewolf-social-deduction-tactics",title:"Mastering Mafia & Werewolf: Psychological Bluffing & Victory Strategies",excerpt:"Learn secret deduction tricks, body language cues, and voting strategies to dominate social deduction games.",content:`Social deduction games like Mafia and Werewolf are psychological battlegrounds where body language, voting patterns, and strategic storytelling determine victory.
...
In daylight phases, frame the conversation around logical inconsistencies rather than raw emotional accusations.`,category:"Game Strategy",author:{name:"Alex Chen",role:"Board Game Strategist",avatar:"/authors/alex.jpg"},publishedAt:"2026-07-15",readTime:"7 min read",tags:["Mafia","Strategy","Bluffing"]},{slug:"gen-z-guide-to-situationships-red-flags-and-green-flags",title:"The Gen Z Guide to Navigating Situationships & Spotting Red Flags",excerpt:"How to transition from soft-launching to real commitment using honest vibe-check conversation cards.",content:`Modern dating can feel like a chaotic cycle of roster dating, soft launches, and undefined situationships.
...
Active listening, consistency in texting, and emotional transparency remain the ultimate green flags.`,category:"Gen Z & Dating",author:{name:"Maya Lin",role:"Gen Z Relationship Writer",avatar:"/authors/maya.jpg"},publishedAt:"2026-07-12",readTime:"5 min read",tags:["Gen Z","Dating","Situationships"]},{slug:"rekindling-romance-for-long-term-couples",title:"5 Daily Connection Rituals to Rekindle Passion in Long-Term Relationships",excerpt:"Simple psychological rituals and conversation decks to stay deeply connected despite busy schedules.",content:`Over time, routine can quietly replace romance. Building daily connection micro-moments restores intimacy.
...
Pick a quiet evening every Sunday to draw 3 cards from the 89 Intimacy Deck.`,category:"Couples Advice",author:{name:"Dr. Sarah Jenkins",role:"Relationship Counselor",avatar:"/authors/sarah.jpg"},publishedAt:"2026-07-10",readTime:"6 min read",tags:["Romance","Intimacy","Long-Term Love"]},{slug:"the-art-of-asking-great-truth-or-dare-questions",title:"The Art of Asking Great Truth or Dare Questions (Without Crossing Boundaries)",excerpt:"How to curate party prompts that generate huge laughs while respecting everyone’s comfort levels.",content:`Truth or Dare is legendary because it balances vulnerability with hilarious actions.
...
Give every player 1 "Pass Token" to maintain trust and ensure nobody feels forced.`,category:"Game Strategy",author:{name:"Marcus Vance",role:"Event Host Specialist",avatar:"/authors/marcus.jpg"},publishedAt:"2026-07-08",readTime:"4 min read",tags:["Truth or Dare","Party Games","Rules"]},{slug:"icebreakers-for-work",title:"70+ Icebreakers for Work: Games for Teams, Meetings & Corporate Groups (2026)",metaTitle:"Icebreakers for Work: 70+ Team & Meeting Games That Actually Land",excerpt:"The complete list of icebreakers for work — quick meeting starters, group icebreakers, team building games, and corporate-safe activities for in-person and remote teams.",content:`Quick answer: The best icebreakers for work take 5–15 minutes, need zero prep, and ask a question rather than force performance. For a fast meeting opener, try a low-pressure round like "One Word Check-In" or "Two Truths and a Lie." For a full team building session, plan a 30–45 minute collaborative challenge instead. Below you'll find them organized by situation — meetings, remote teams, large groups, and corporate settings — so you can grab exactly what you need in under a minute.
...
Skip writing your own prompts. [Sparkers Games' Office Teams collection](https://www.sparkersgames.com/en/play/office/) has ready-to-play digital decks built specifically for meetings, remote standups, and offsites — no prep, no printing, just open and play.`,category:"Icebreakers & Social",author:{name:"David Ross",role:"Corporate Culture Coach",avatar:"/authors/david.jpg"},publishedAt:"2026-08-15",readTime:"12 min read",tags:["icebreakers for work","group icebreakers","work icebreakers","icebreaker games for work","team icebreakers","meeting ice breaker games","teamwork icebreakers","corporate icebreakers","team building icebreakers"],faqs:[{question:"What is a good icebreaker for a work meeting?",answer:"A good meeting icebreaker takes under five minutes, doesn't require preparation from participants, and is optional to answer in depth. One-Word Check-In and Two Truths and a Lie consistently work because everyone can participate at their own comfort level."},{question:"How do you make icebreakers feel less forced at work?",answer:"Keep them short, make sharing details optional, and rotate who goes first so the same person isn't always put on the spot. Icebreakers that ask a genuine, low-stakes question tend to land better than ones that demand performance, like singing or acting."},{question:"What are good icebreakers for remote or virtual teams?",answer:"Camera-friendly prompts (background stories, desk show-and-tell) and async chat threads work best for remote teams, since they don't depend on everyone talking over each other on a call or being in the same timezone."},{question:"How long should a team building icebreaker be?",answer:"Quick check-ins should stay under 5 minutes. Group and team icebreakers for a meeting run 5–15 minutes. Full team building activities — the kind meant for an offsite or workshop — typically need 30–60 minutes to be worthwhile."},{question:"Do icebreakers actually improve team performance?",answer:"They build the relational trust that makes collaboration faster — teams that know each other well tend to communicate more openly and resolve friction more quickly, which is the underlying reason companies invest in team building icebreakers at all."}]},{slug:"meeting-ice-breaker-games",title:"25 Meeting Ice Breaker Games You Can Run in Under 5 Minutes",metaTitle:"Meeting Ice Breaker Games: 25 Fast Picks (Under 5 Minutes)",excerpt:"25 meeting ice breaker games that take five minutes or less — no prep, no materials, no awkward silences. Perfect for standups, all-hands, and client calls.",content:`Quick answer: The fastest meeting ice breaker games ask one simple question that everyone can answer in a sentence or less — no props, no pairing off, no prep time. One-Word Check-In, Two Truths and a Lie, and This-or-That are the three most reliable openers because they scale from a 3-person standup to a 40-person all-hands without slowing down.
...
Looking for a longer list, including team building and group activities for full offsites? See the complete guide to [icebreakers for work](https://www.sparkersgames.com/en/blog/icebreakers-for-work/), or grab a ready-made deck from [Sparkers' Office Teams collection](https://www.sparkersgames.com/en/play/office/) — no prep required.`,category:"Icebreakers & Social",author:{name:"David Ross",role:"Corporate Culture Coach",avatar:"/authors/david.jpg"},publishedAt:"2026-08-15",readTime:"5 min read",tags:["meeting ice breaker games","quick icebreakers for meetings","5 minute icebreakers","virtual meeting icebreakers","icebreaker questions for meetings","icebreakers for work"],faqs:[{question:"What's a good icebreaker to start a meeting?",answer:"Something under two minutes that everyone can answer without preparation — a one-word check-in or a simple either/or question consistently works best because no one has to think too hard or perform."},{question:"What icebreakers work for virtual meetings?",answer:"Chat-based and camera-friendly prompts work best for virtual meetings, since they don't rely on people unmuting one at a time. Async warm-up questions dropped in chat before the call starts are especially effective for hybrid teams across time zones."},{question:"How do I keep a meeting icebreaker from running long?",answer:'Set an explicit time cap out loud before starting ("30 seconds each"), and pick a format — like a poll or one-word answer — that structurally can\'t run long.'}]},{slug:"staff-meeting-ice-breakers",title:"20 Staff Meeting Ice Breakers That Won't Waste Anyone's Time",metaTitle:"Staff Meeting Ice Breakers: 20 Fast, Low-Effort Picks",excerpt:"20 staff meeting ice breakers and games at meetings that take under five minutes — built for recurring team, department, and all-staff meetings.",content:`Quick answer: Staff meeting ice breakers work best when they're recurring and low-effort — the same simple format (a rotating one-word check-in, a weekly either/or question) used consistently beats a new elaborate game every week. Staff meetings happen often enough that novelty burns out fast; consistency and speed matter more than creativity here.
...
Looking for options beyond staff meetings — team building, remote teams, or larger group sessions? See the full guide to [icebreakers for work](https://www.sparkersgames.com/en/blog/icebreakers-for-work/) or the fast-format list of [meeting ice breaker games](https://www.sparkersgames.com/en/blog/meeting-ice-breaker-games/). For ready-made prompts you don't have to write yourself, try [Sparkers' Office Teams decks](https://www.sparkersgames.com/en/play/office/).`,category:"Icebreakers & Social",author:{name:"David Ross",role:"Corporate Culture Coach",avatar:"/authors/david.jpg"},publishedAt:"2026-08-15",readTime:"5 min read",tags:["staff meeting ice breakers","games at meetings","icebreakers for staff meetings","quick staff meeting openers","department meeting icebreakers","icebreakers for work"],faqs:[{question:"What's a quick icebreaker for a staff meeting?",answer:"A one-word check-in or a single either/or question is the fastest option — both take under a minute per person and work for staff meetings of any size."},{question:"How often should you use a staff meeting icebreaker?",answer:"Weekly is common, but the format matters more than the frequency — reusing the same simple prompt style (just changing the question) keeps it fast without feeling repetitive."},{question:"What are good games at meetings for large, mixed-department groups?",answer:"Games that don't require pairing everyone up individually work best for large or mixed groups — Human Bingo, trivia rounds, and poll-based warm-ups all scale without slowing the meeting down."}]},{slug:"icebreaker-activities-for-adults",title:"40 Icebreaker Activities for Adults (Work, Groups & Social Events)",metaTitle:"Icebreaker Activities for Adults: 40 Picks for Any Group",excerpt:"40 icebreaker activities for adults, organized by setting — office, classroom, party, and large group — with time and group-size guidance for each.",content:`Quick answer: The best icebreaker activities for adults match the setting they're used in — professional prompts for the office, playful ones for parties, and collaborative challenges for classrooms or workshops. Two Truths and a Lie and Human Bingo are the two most versatile picks because both work across nearly every adult setting without modification.
...
For work-specific formats — meetings, staff gatherings, and team building — see the full guide to [icebreakers for work](https://www.sparkersgames.com/en/blog/icebreakers-for-work/). For party and social settings specifically, browse [Sparkers' full party games library](https://www.sparkersgames.com/en/play/).`,category:"Icebreakers & Social",author:{name:"David Ross",role:"Corporate Culture Coach",avatar:"/authors/david.jpg"},publishedAt:"2026-08-15",readTime:"6 min read",tags:["icebreaker activities for adults","adult icebreaker games","group activities for adults","icebreaker games for grown ups","fun activities for adult groups","icebreakers for work"],faqs:[{question:"What are good icebreaker activities for adults that don't feel juvenile?",answer:"Activities built around real self-disclosure or light discussion — like Two Truths and a Lie, Career Firsts, or a Would You Rather tied to a real topic — tend to feel more appropriate for adults than performance-based games borrowed from kids' classrooms."},{question:"What's the best icebreaker for a large adult group?",answer:"Speed networking, poll-based warm-ups, and Human Bingo all scale well past 20 people because they don't require the facilitator to track individual turns."},{question:"Are icebreaker activities for adults different from ones for teens or kids?",answer:"Yes — adult versions generally lean on genuine questions and light self-disclosure rather than physical games or performance, and they tend to respect time constraints more strictly."}]},{slug:"team-building-icebreakers",title:"15 Team Building Icebreakers That Build Real Teamwork",metaTitle:"Team Building Icebreakers: 15 Games That Build Real Teamwork",excerpt:"15 team building icebreakers and teamwork icebreaker games designed to build lasting collaboration, not just break silence once.",content:`Quick answer: A teamwork icebreaker is different from a one-time meeting warm-up — it's designed for people who'll keep collaborating, so the best ones surface working styles, hidden skills, or shared goals rather than just breaking silence once. Personal User Manuals and Skill Swap Rounds are the two most practical picks because the answers directly change how the team works together afterward.
...
For quick meeting-only formats, see [meeting ice breaker games](https://www.sparkersgames.com/en/blog/meeting-ice-breaker-games/). For the complete list across every work setting, see the full guide to [icebreakers for work](https://www.sparkersgames.com/en/blog/icebreakers-for-work/), or grab a ready-made deck from [Sparkers' Office Teams collection](https://www.sparkersgames.com/en/play/office/).`,category:"Icebreakers & Social",author:{name:"David Ross",role:"Corporate Culture Coach",avatar:"/authors/david.jpg"},publishedAt:"2026-08-15",readTime:"5 min read",tags:["team building icebreakers","teamwork icebreaker","icebreaker team building","ice breakers for work team building","teamwork ice breaker games","icebreakers for work"],faqs:[{question:"What's the difference between a teamwork icebreaker and a regular icebreaker?",answer:"A teamwork icebreaker is chosen for a group that will keep collaborating, so it's designed to surface something useful — working styles, hidden skills, shared goals — rather than just breaking silence for a single meeting."},{question:"What's a good icebreaker for team building at work?",answer:"Personal User Manuals and Skill Swap rounds are especially effective because the information stays useful long after the activity ends, unlike a one-time icebreaker game."},{question:"How long should a team building icebreaker session be?",answer:"Quick teamwork icebreakers run 5–10 minutes; deeper team building challenges built for offsites or workshops typically need 20–45 minutes to be worthwhile."}]},{slug:"strategic-thinking-icebreakers",title:"12 Strategic Thinking Icebreakers for Smarter, Sharper Teams",metaTitle:"Strategic Thinking Icebreakers: 12 Games for Sharper Teams",excerpt:"12 strategic thinking icebreakers designed to warm up critical thinking before planning sessions, strategy meetings, and workshops.",content:`Quick answer: Strategic thinking icebreakers are built to warm up analytical and creative thinking before a planning session, not just to break silence — they typically involve a small scenario, trade-off, or puzzle instead of a purely personal question. Utopia/Dystopia Backcasting and Desert Island Priorities are the two most effective, because both force real prioritization and trade-off thinking in under ten minutes.
...
For a broader set of options across every work setting, see the complete guide to [icebreakers for work](https://www.sparkersgames.com/en/blog/icebreakers-for-work/), or explore [team building icebreakers](https://www.sparkersgames.com/en/blog/team-building-icebreakers/) for longer collaborative formats. For ready-made prompts, try [Sparkers' Office Teams decks](https://www.sparkersgames.com/en/play/office/).`,category:"Icebreakers & Social",author:{name:"David Ross",role:"Corporate Culture Coach",avatar:"/authors/david.jpg"},publishedAt:"2026-08-15",readTime:"5 min read",tags:["strategic thinking icebreakers","critical thinking icebreakers","planning meeting icebreakers","problem solving icebreakers","strategy session warm-up activities","icebreakers for work"],faqs:[{question:"What is a strategic thinking icebreaker?",answer:"It's a warm-up activity that exercises prioritization, trade-off reasoning, or structured argument — rather than just personal disclosure — so a group is mentally ready for a planning or strategy session."},{question:"How is a strategic thinking icebreaker different from a regular team icebreaker?",answer:"A regular icebreaker is built to build rapport and lower social tension. A strategic thinking icebreaker does that too, but is specifically designed around the kind of thinking — prioritization, argument, pattern recognition — the meeting is about to require."},{question:"How long should a strategic thinking icebreaker take?",answer:"Most run 5–10 minutes; deeper ones like Desert Island Priorities or a Build Challenge can run 15–20 minutes if used as a fuller warm-up before a longer planning session."}]},{slug:"long-distance-relationship-date-ideas",title:"How to Have Fun Virtual Date Nights in Long-Distance Relationships",excerpt:"Creative video call date ideas, synchronized card games, and remote connection strategies.",content:`Distance doesn’t have to drain the spark out of your connection.
...
Cook the same recipe in your respective kitchens before sitting down for a digital candlelight dinner.`,category:"Couples Advice",author:{name:"Maya Lin",role:"Relationship Writer",avatar:"/authors/maya.jpg"},publishedAt:"2026-07-03",readTime:"6 min read",tags:["Long Distance","Virtual Date","Couples"]},{slug:"top-10-drinking-games-for-adult-game-nights",title:"Top 10 Adult Drinking & Party Card Games for Unforgettable Gatherings",excerpt:"Ranked guide to the funniest 21+ card games, rules, and hosting tips for weekend parties.",content:`Looking to elevate your weekend house party? Adult card games add instant energy and hilarity.
...
Point at the player most likely to get locked out of their own apartment!`,category:"Party Tips",author:{name:"Marcus Vance",role:"Event Host Specialist",avatar:"/authors/marcus.jpg"},publishedAt:"2026-06-28",readTime:"7 min read",tags:["Drinking Games","Adult Party","21+"]},{slug:"psychology-of-deep-questions-why-card-decks-work",title:"The Science of Connection: Why Structured Conversation Cards Deepen Friendships",excerpt:"Discover the psychological research behind vulnerability, active listening, and structured question decks.",content:`Psychological studies show that structured mutual vulnerability (like Arthur Aron's 36 Questions) accelerates trust.
...
Reciprocal sharing creates deep neural alignment and feelings of safety between friends and partners.`,category:"Game Strategy",author:{name:"Dr. Sarah Jenkins",role:"Relationship Counselor",avatar:"/authors/sarah.jpg"},publishedAt:"2026-06-25",readTime:"8 min read",tags:["Psychology","Communication","Connection"]},{slug:"first-date-questions-that-are-not-boring",title:"20 First Date Questions That Are Actually Fun (No Resume Interrogations)",excerpt:"Ditch boring work questions and use engaging, playful icebreakers that spark real chemistry.",content:`Nobody wants a first date to feel like a job interview.
...
"What was your absolute favorite Saturday morning cartoon growing up?"`,category:"Gen Z & Dating",author:{name:"Maya Lin",role:"Gen Z Relationship Writer",avatar:"/authors/maya.jpg"},publishedAt:"2026-06-20",readTime:"5 min read",tags:["First Date","Icebreakers","Gen Z"]},{slug:"would-you-rather-questions-for-couples",title:"100+ Best Would You Rather Questions for Couples (Fun, Deep & Spicy)",excerpt:"The ultimate collection of Would You Rather questions designed specifically for couples to ignite conversation, laughter, and romance.",content:`Would You Rather is one of the most effective conversation starters for couples whether you have been dating for 3 months or married for 10 years.
...
Draw cards from our online [Would You Rather Game Deck](/en/play/would-you-rather/) or [89 Intimacy Deck](/en/couples/deep-intimacy/) for instant interactive fun!`,category:"Couples Advice",author:{name:"Dr. Sarah Jenkins",role:"Relationship Counselor",avatar:"/authors/sarah.jpg"},publishedAt:"2026-07-22",readTime:"6 min read",tags:["Couples","Would You Rather","Date Night"]},{slug:"never-have-i-ever-questions-for-couples",title:"75 Never Have I Ever Questions for Couples (Uncover Fun Secrets)",excerpt:"Fun, flirty, and surprising Never Have I Ever questions designed for partners and date nights.",content:`Never Have I Ever is not just for college parties — it is a fantastic way for couples to learn secret stories about each other's past.
...
Play the interactive [Never Have I Ever Online Deck](/en/play/never-have-i-ever/) with finger counters!`,category:"Couples Advice",author:{name:"Maya Lin",role:"Gen Z Relationship Writer",avatar:"/authors/maya.jpg"},publishedAt:"2026-07-21",readTime:"5 min read",tags:["Never Have I Ever","Couples","Flirty"]},{slug:"deep-questions-to-ask-your-partner",title:"50 Deep Questions to Ask Your Partner to Strengthen Your Emotional Bond",excerpt:"Meaningful, psychology-backed questions to deepen intimacy, vulnerability, and mutual trust.",content:`Psychologists emphasize that emotional intimacy requires continuous curiosity about your partner's evolving inner world.
...
Explore the full 25-prompt [89 Intimacy & Soul Deck](/en/couples/deep-intimacy/) online for free!`,category:"Couples Advice",author:{name:"Dr. Sarah Jenkins",role:"Relationship Counselor",avatar:"/authors/sarah.jpg"},publishedAt:"2026-07-23",readTime:"7 min read",tags:["Intimacy","Deep Questions","Relationship Advice"]}];var c=e.i(26091),h=e.i(68877),d=e.i(74544);let u=(0,e.i(56420).default)("user",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);var m=e.i(56423);e.s(["default",0,function({params:e}){let g=a.use(e).locale,[p,f]=a.useState("all"),k=["all",...Array.from(new Set(l.map(e=>e.category)))],y=l.filter(e=>"all"===p||e.category===p);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(o.Breadcrumbs,{items:[{name:"Home",url:`/${g}`},{name:"Blog",url:`/${g}/blog`}]}),(0,t.jsx)("div",{className:"flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-200 dark:border-slate-800 pb-6",children:(0,t.jsxs)("div",{children:[(0,t.jsxs)(s.Badge,{variant:"default",className:"mb-2",children:[(0,t.jsx)(c.FileText,{className:"w-3.5 h-3.5"})," Sparkers Journal"]}),(0,t.jsx)("h1",{className:"text-3xl sm:text-4xl font-heading font-extrabold text-slate-900 dark:text-white",children:"Party Guides, Icebreakers & Connection Rituals"}),(0,t.jsx)("p",{className:"text-sm text-slate-600 dark:text-slate-400 mt-1",children:"Expert guides on workplace icebreakers, team building, relationship intimacy, and party game strategies."})]})}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:k.map(e=>(0,t.jsx)("button",{onClick:()=>f(e),className:`px-3 py-1.5 text-xs font-semibold rounded-full transition-colors cursor-pointer ${p===e?"bg-emerald-600 text-white shadow-xs":"bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800"}`,children:"all"===e?"All Posts":e},e))}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 pt-2",children:y.map(e=>{let a="icebreakers-for-work"===e.slug;return(0,t.jsxs)(i.Card,{variant:"default",className:`flex flex-col justify-between transition-all duration-200 ${a?"md:col-span-2 border-2 border-emerald-500/80 dark:border-emerald-500/60 bg-emerald-50/30 dark:bg-emerald-950/20 shadow-md":"hover:border-slate-300 dark:hover:border-slate-700"}`,children:[(0,t.jsxs)(i.CardHeader,{children:[(0,t.jsxs)("div",{className:"flex items-center justify-between gap-2",children:[(0,t.jsx)("div",{className:"flex items-center gap-2",children:a?(0,t.jsxs)(s.Badge,{variant:"default",className:"bg-emerald-600 text-white font-bold",children:[(0,t.jsx)(m.BookOpen,{className:"w-3.5 h-3.5"})," 📌 Pillar Guide"]}):(0,t.jsx)(s.Badge,{variant:"Couples Advice"===e.category?"couples":"Icebreakers & Social"===e.category?"default":"play",children:e.category})}),(0,t.jsxs)("span",{className:"flex items-center gap-1 text-xs text-slate-400",children:[(0,t.jsx)(d.Clock,{className:"w-3.5 h-3.5"})," ",e.readTime]})]}),(0,t.jsx)(i.CardTitle,{className:`mt-3 ${a?"text-2xl sm:text-3xl font-extrabold text-emerald-950 dark:text-emerald-300":"text-xl"}`,children:e.title}),(0,t.jsx)(i.CardDescription,{className:a?"text-sm text-slate-700 dark:text-slate-300 leading-relaxed":"",children:e.excerpt})]}),(0,t.jsxs)(i.CardFooter,{className:"flex items-center justify-between pt-4",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400",children:[(0,t.jsx)(u,{className:"w-3.5 h-3.5 text-emerald-600"})," ",e.author.name,e.author.role?` (${e.author.role})`:""]}),(0,t.jsx)(r.default,{href:`/${g}/blog/${e.slug}`,children:(0,t.jsxs)(n.Button,{variant:"default",size:"sm",className:a?"bg-emerald-600 hover:bg-emerald-700 text-white":"",children:["Read Article ",(0,t.jsx)(h.ArrowRight,{className:"w-3.5 h-3.5"})]})})]})]},e.slug)})})]})}],22527)}]);