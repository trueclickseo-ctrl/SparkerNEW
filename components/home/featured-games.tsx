  ...
  const games = [
    {
      ...
      description: 'Over 500+ dares and deep truths designed for parties and icebreakers.',
    ...
    },
    {
      ...
      description: 'Hilarous & impossible dilemmas for friendly debates.',
      category: 'Party Games',
      audience: 'All Ages',
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {games.map((game) => (
          <Card key={game.id} variant={game.variant} className="flex flex-col justify-between">
            <CardHeader>
