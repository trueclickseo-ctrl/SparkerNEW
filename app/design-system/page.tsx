  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 py-12 px-4 sm:px-6 lg:px-8 space-y-12">
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        {/* Cards Showcase */}
        <section className="space-y-4">
          <h2 className="text-xl font-bold font-heading">Cards (Themed Containers)</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card variant="default">
              ...
              <CardContent>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Over 500+ dares and truths designed to break the ice instantly.
                </p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="default" className="w-full">Play Deck</Button>
              </CardFooter>
            </Card>
            ...
            <Card variant="play">
              ...
              <CardContent>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Interactive voting with randomizer and difficulty filters.
                </p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="play" className="w-full">Launch Game</Button>
              </CardFooter>
            </Card>
            ...
            <Card variant="couples">
              <CardHeader>
                ...
                <CardDescription>Romantic & flirty prompts for partners.</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  89 Framework questions for deep conversations and bonding.
                </p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="couples" className="w-full">Open Deck</Button>
              </CardFooter>
            </Card>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            <Alert variant="info" title="AEO & GEO Ready">
              Direct answer snippets integrated across all cards and encyclopedia routes.
            </Alert>
            <Alert variant="couples" title="Intimacy Ground Rules">
              Always establish safe words and consensual comfort levels before playing deep intimacy prompts.
            </Alert>
          </div>
        </section>
        ...
        {/* Interactive Triggers (Modal & Toast) */}
        <section className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <Button variant="outline" onClick={() => setShowToast(true)}>Show Toast Notification</Button>
          </div>
        </section>
      </div>
      ...
      <Modal
        ...
        title="Interactive Deck Options"
        description="Configure your session filters and difficulty levels."
      >
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
          This modal dialog is fully accessible and responds to Escape key presses and backdrop clicks.
        </p>
        <Button variant="default" className="w-full" onClick={() => setIsModalOpen(false)}>
          Save Configuration
        </Button>
      </Modal>

      <Toast
        message="Game deck added to your favorites!"
        isVisible={showToast}
