...
Explore the full 25-prompt [89 Intimacy & Soul Deck](/en/couples/deep-intimacy/) online for free!`,category:"Couples Advice",author:{name:"Dr. Sarah Jenkins",role:"Relationship Counselor",avatar:"/authors/sarah.jpg"},publishedAt:"2026-07-23",readTime:"7 min read",tags:["Intimacy","Deep Questions","Relationship Advice"]}];var c=e.i(56420);let h=(0,c.default)("file-text",[["path",{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z",key:"1oefj6"}],["path",{d:"M14 2v5a1 1 0 0 0 1 1h5",key:"wfsgrz"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);var d=e.i(68877),u=e.i(74544);let m=(0,c.default)("user",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);e.s(["default",0,function({params:e}){let c=a.use(e).locale,[g,p]=a.useState("all"),f=["all",...Array.from(new Set(l.map(e=>e.category)))],k=l.filter(e=>"all"===g||e.category===g);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(o.Breadcrumbs,{items:[{name:"Home",url:`/${c}`},{name:"Blog",url:`/${c}/blog`}]}),(0,t.jsx)("div",{className:"flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-200 dark:border-slate-800 pb-6",children:(0,t.jsxs)("div",{children:[(0,t.jsxs)(s.Badge,{variant:"default",className:"mb-2",children:[(0,t.jsx)(h,{className:"w-3.5 h-3.5"})," Sparkers Journal"]}),(0,t.jsx)("h1",{className:"text-3xl sm:text-4xl font-heading font-extrabold text-slate-900 dark:text-white",children:"Party Guides & Relationship Advice"}),(0,t.jsx)("p",{className:"text-sm text-slate-600 dark:text-slate-400 mt-1",children:"Expert articles on connection rituals, party hosting, and communication strategy."})]})}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:f.map(e=>(0,t.jsx)("button",{onClick:()=>p(e),className:`px-3 py-1.5 text-xs font-semibold rounded-full transition-colors cursor-pointer ${g===e?"bg-emerald-600 text-white":"bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800"}`,children:"all"===e?"All Posts":e},e))}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 pt-2",children:k.map(e=>(0,t.jsxs)(i.Card,{variant:"default",className:"flex flex-col justify-between",children:[(0,t.jsxs)(i.CardHeader,{children:[(0,t.jsxs)("div",{className:"flex items-center justify-between",children:[(0,t.jsx)(s.Badge,{variant:"Couples Advice"===e.category?"couples":"play",children:e.category}),(0,t.jsxs)("span",{className:"flex items-center gap-1 text-xs text-slate-400",children:[(0,t.jsx)(u.Clock,{className:"w-3.5 h-3.5"})," ",e.readTime]})]}),(0,t.jsx)(i.CardTitle,{className:"mt-3 text-xl",children:e.title}),(0,t.jsx)(i.CardDescription,{children:e.excerpt})]}),(0,t.jsxs)(i.CardFooter,{className:"flex items-center justify-between",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 text-xs text-slate-500",children:[(0,t.jsx)(m,{className:"w-3.5 h-3.5 text-emerald-600"})," ",e.author.name]}),(0,t.jsx)(r.default,{href:`/${c}/blog/${e.slug}`,children:(0,t.jsxs)(n.Button,{variant:"default",size:"sm",children:["Read Article ",(0,t.jsx)(d.ArrowRight,{className:"w-3.5 h-3.5"})]})})]})]},e.slug))})]})}],22527)}]);